#ifndef GLCHESS_SRC_ENGINE_EVENT_HANDLER_INPUT_HANDLER_H_
#define GLCHESS_SRC_ENGINE_EVENT_HANDLER_INPUT_HANDLER_H_
...
#endif //GLCHESS_SRC_ENGINE_EVENT_HANDLER_INPUT_HANDLER_H_
